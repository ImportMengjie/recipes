...
DESCRIPTION
       ...
       * Any of the threads in the process calls exit(3), or the main thread performs a return from main().  This causes the termination of all threads in the
         process.
...
NOTES
       ...
       ited", a per-architecture value is used for the stack size.  Here is the value for a few architectures:
...
thread_start(void *arg)
{
   ...
   printf("Thread %d: top of stack near %p; argv_string=%s\n",
	   tinfo->thread_num, &uargv, tinfo->argv_string);
